...
Assert-True ($installPs1.Contains("`$Adapter -eq 'openclaude' -or `$Adapter -eq 'codex'")) "scripts/install.ps1 routes OpenClaude through the shared native adapter path"
